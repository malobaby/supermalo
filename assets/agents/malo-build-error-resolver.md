---
name: malo-build-error-resolver
...
**不使用场景：**
- 代码需要重构（使用 malo-refactor-cleaner）
- 需要架构更改（使用 malo-architect）
- 需要新功能（使用 malo-planner）
- 测试失败（使用 malo-tdd-guide）
- 发现安全问题（使用 malo-security-reviewer）
